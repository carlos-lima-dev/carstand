    ...
    <div className={styles.container}>
      <div className={styles.car_grid}>
        <div className={styles.car_left}>
          ...
          <img src={selectedImage} alt="Carro" onClick={handleMainImageClick} />
      ...
      <div className={styles.faq_grid}>
        ...
        <details>
          ...
          <p className={styles.faq_p_size}>
            ...
            Vencimento; Cartão de Cidadão; Comprovativo de NIB; Comprovativo de
            Morada; Folha do IRS;
          </p>
        </details>
        <details>
          ...
          <p className={styles.faq_p_size}>
            Sim, aceitamos a retoma. Depois de uma avaliação geral ao seu carro
            atual iremos atribuir-lhe um valor. Caso aceite o valor, este pode
            ser deduzido na compra do novo carro.
          </p>
        </details>
        <details>
          <summary>É possivel realizar um test-drive à viatura?</summary>
          <p className={styles.faq_p_size}>
            Sim, com marcação prévia. Durante o test-drive irá ser acompanhado/a
            por um dos responsáveis por questões de segurança.
          </p>
        </details>
      </div>
    </div>
