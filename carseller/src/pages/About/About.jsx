  ...
  return (
    <div className={styles.container}>
      ...
      <div className={styles.container_grid}>
        <div className={styles.container_grid_left}>
          ...
          <p>
            ...
            2000. Trabalhamos sempre com base nos mesmos princípios, confiança e
            profissionalismo e, ao longo dos anos adquirimos um novo, a
            experiência. O stand dispõe de um espaço físico, aberto ao público,
            com um grande stock de viaturas, que variam nas suas características
            e preço, tendo por objetivo conseguir servir os nossos clientes,
            independentemente daquilo que procurem
          </p>
        </div>
      ...
      <div className={styles.container_grid_mission}>
        <p>Missão</p>
        <p>
          A nossa missão consiste em servir os nossos clientes, de maneira a que
          se tornem clientes para sempre e não para uma vez só. Acreditamos que
          quando o serviço é bem prestado, outros clientes irão aparecer através
          de recomendações. É sobre este fundamento que trabalhamos com gosto e
          vontade há 20 anos.
        </p>
      </div>
